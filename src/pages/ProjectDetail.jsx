...
export default function ProjectDetail() {
  ...
  return (
    <main className="w-full min-h-screen bg-white">
      ...
      <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <button 
            ...
            className="px-5 py-2 bg-blue-600 text-white font-bold text-sm rounded-lg hover:bg-blue-700 transition shadow-sm"
          >
            Contact Me
          </button>
        </div>
      ...
      {/* Hero Section */}
      <section className="w-full bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="mb-4 inline-block px-4 py-1.5 bg-white/20 backdrop-blur-md rounded-full text-xs font-extrabold uppercase tracking-wider border border-white/30">
            {project.course}
          </div>
          <h1 className="text-4xl lg:text-6xl font-black mb-4 leading-tight">{project.title}</h1>
          <p className="text-lg font-semibold text-blue-100">{project.semester}</p>
        </div>
      </section>
      ...
      <section className="w-full py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 space-y-16">
          ...
          <div className="space-y-6 py-8 border-b border-gray-200">
            <h2 className="text-3xl font-black text-gray-900">Contribution & Implementation</h2>
            <p className="text-lg text-gray-700 leading-relaxed font-medium">
          ...
          <div className="space-y-6 py-8">
            <h2 className="text-3xl font-black text-gray-900">Technology Stack</h2>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {project.technologies.map((tech, idx) => (
                <div 
                  key={idx}
                  className="px-4 py-3 bg-blue-50 border border-blue-200 rounded-xl text-blue-700 font-bold text-center hover:bg-blue-100 transition"
                >
                  {tech}
                </div>
              ))}
          ...
          {project.githubUrl && (
            <div className="space-y-6 py-8 bg-gray-50 px-8 rounded-2xl border border-gray-200">
              <h2 className="text-2xl font-black text-gray-900">Source Code</h2>
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 px-6 py-3 bg-gray-900 text-white font-bold rounded-xl hover:bg-gray-800 transition"
              >
          ...
          {project.huggingfaceUrl && (
            <div className="space-y-6 py-8 bg-orange-50 px-8 rounded-2xl border border-orange-200">
              <h2 className="text-2xl font-black text-gray-900">Live Demo</h2>
              <p className="text-gray-700 font-medium mb-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 px-6 py-3 bg-orange-400 text-white font-bold rounded-xl hover:bg-orange-500 transition"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <section className="w-full bg-gray-50 py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <h2 className="text-3xl font-black text-gray-900 mb-12">More Projects</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {projectsData
              ...
              .map(relatedProject => (
                ...
                >
                  <div className="h-32 bg-gradient-to-br from-blue-600 to-indigo-700 p-6 flex flex-col justify-end">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div>
              ...
              <p className="font-medium">MSc Computer Science & Engineering student at DTU.</p>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><button onClick={() => setIsContactOpen(true)} className="hover:text-white transition font-semibold text-left">Contact</button></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <button onClick={() => setIsContactOpen(true)} className="font-medium text-sm text-left hover:text-white transition">
                s252744@student.dtu.dk<br/>Copenhagen, Denmark
              </button>
            </div>
          </div>
